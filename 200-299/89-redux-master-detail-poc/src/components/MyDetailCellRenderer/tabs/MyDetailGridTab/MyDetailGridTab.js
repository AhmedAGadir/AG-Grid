...
class MyDetailGridTab extends Component {
    ...
    onGridReady(params) {
        ...
        // ********************
        this.registerDetailGridId(params);
        this.masterApi.addEventListener('refreshDetailNode', this.refreshDetailNodeHandler.bind(this))
        // ********************
    ...
    // ********************
    refreshDetailNodeHandler(params) {
        console.log('in event handler', this)
        this.detailApi.refreshCells({ force: true });
        this.detailApi.redrawRows();

    }
    // ********************

    // ********************
    registerDetailGridId(params) {
        var detailGridId = "detail_" + this.masterIndex;
        var detailGridInfo = {
            id: detailGridId,
            api: this.detailApi,
            columnApi: params.columnApi
        }
        this.masterApi.addDetailGridInfo(detailGridId, detailGridInfo);
    }
    // ********************
