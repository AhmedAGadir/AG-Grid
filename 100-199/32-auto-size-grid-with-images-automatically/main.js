...
var gridOptions = {
    columnDefs: [
        { headerName: 'Country', field: 'country', cellRenderer: 'countryCellRenderer' },
...
function autoSizeColumns() {
    ...
    gridOptions.api.forEachNode(node => {
        var cellRenderer = gridOptions.api.getCellRendererInstances({ rowNodes: [node], columns: ['richText'] })[0];
        if (!cellRenderer) {
            return;
        }
        var nodeImgWidth = cellRenderer.eGui.querySelector('img').width;
        widestImg = nodeImgWidth > widestImg ? nodeImgWidth : widestImg;
    })
    gridOptions.columnApi.setColumnWidth(columns[0], widestImg);
    columns.shift();
